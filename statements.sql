...
-- Tu respuesta aquí
SELECT id_usuario, nombre, apellido, lenguaje FROM usuarios_lenguajes GROUP BY id_usuario ORDER BY nombre;
...
-- Tu respuesta aquí
SELECT edad, GROUP_CONCAT(nombre) as usuarios_con_misma_edad FROM usuarios_lenguajes GROUP BY edad HAVING COUNT(*) > 1;
...
-- Tu respuesta aquí
SELECT id_usuario, CONCAT(nombre, ' ', apellido) as nombre_completo, email FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT id_usuario, CONCAT(nombre, ' ', apellido) as nombre_completo FROM usuarios_lenguajes WHERE lenguaje IS NULL OR lenguaje <> 'SQL';
